...
export type SupportedSeverity = 'info' | 'low' | 'moderate' | 'high' | 'critical'
export type RemoteConnectivityProtocol = 'https' | 'ssh'
export type RemoteWorkspaceProviderName = 'gitlab' | 'gitlab-self-managed' | 'git-clone'
...
export type ResolvedAuditSource = ResolvedLocalAuditSource | ResolvedRemoteAuditSource
