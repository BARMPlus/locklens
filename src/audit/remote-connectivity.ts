...
export function resolveRemoteConnectivityTarget(repositoryUrl: string): RemoteConnectivityTarget {
...
function probeTcpConnectivity(target: RemoteConnectivityTarget, timeoutMs: number): Promise<void> {
