...
async function main() {
  ...
  // const source = 'https://gitlab.com/gitlab-org/gitlab-vscode-extension' // gitLab 公开仓库（HTTPS 方式）
  // const source = 'git@gitlab.com:gitlab-org/gitlab-vscode-extension.git' // gitLab 公开仓库（SSH 方式）
  // const source = 'https://gitlab.com/ccz-Eric/jenkins-build' // gitLab 私有仓库（HTTPS 方式）
  // const source = 'git@gitlab.com:ccz-Eric/jenkins-build.git' // gitLab 私有仓库（SSH 方式）
